    ...
    <div class="flex flex-wrap pr-8">
        <div class="p-10">
            ...
            <div class="min-w-lg rounded shadow-lg">
                <h2 class="p-6 text-2xl">Add Blog Post</h2>


                <form class="mt-8 mr-6 mb-16 ml-6" action="{{ url('admin/blog-post/store') }}" method="post" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="">
                      ...
                      <input type="text" name="title" id="title" placeholder="enter post title" class="px-3 py-3 placeholder-blueGray-300 text-blueGray-600 relative bg-white bg-white rounded text-sm border-0 shadow outline-none focus:outline-none focus:ring w-full"/>
                    </div>
