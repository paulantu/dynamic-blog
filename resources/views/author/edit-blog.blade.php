...
@section('content')
    ...
    <section class="container mx-auto py-6 mt-16 mb-12">
        ...
        <div class="min-w-lg rounded shadow-lg">
            ...
            <form class="mt-8 mr-6 mb-16 ml-6" action="{{ url('author/update/blog-post/'.$blogPostData->id) }}" method="post" enctype="multipart/form-data">
                @csrf
                @method('put')
                <div class="grid grid-cols-3 gap-4">
                    <div class="">
                        ...
                        <input type="text" value="{{ $blogPostData->title }}" name="title" id="title" placeholder="enter post title" class="px-3 py-3 placeholder-blueGray-300 text-blueGray-600 relative bg-transparent rounded text-sm border-0 shadow outline-none focus:outline-none focus:ring w-full"/>
                    </div>
                ...
                <div class="mt-8">
                    ...
                    <div class="flex w-full flex-wrap items-stretch mb-3 mt-2">
                        <textarea class="px-3 py-3 placeholder-blueGray-300 text-yellow-500 relative bg-transparent rounded text-sm border-0 shadow outline-none focus:outline-none focus:ring w-full pl-10" name="description"
                                  id="description" aria-describedby="description" placeholder="enter description">{{ $blogPostData->description }}</textarea>
                    </div>
                ...
                <div class="mt-8 mb-12 ">
                    ...
                    <div class="flex flex-wrap items-stretch mb-1">
                       <textarea class="w-full px-3 py-3 placeholder-blueGray-300 text-color relative bg-transparent rounded text-sm border-0 shadow outline-none focus:outline-none focus:ring pl-10" name="summary"
                                 id="summary" aria-describedby="summary" placeholder="enter summary">{{ $blogPostData->summary }}</textarea>
                    </div>
